...
and a key and returns a new array with all the objects that contain that 
key.
...
(HINT - you can use map and filter to double and then filter the odd 
    numbers).
...
function doubleOddNumbers(arr) {
    ...
    return doubleValues(oddNumbers);    
}
